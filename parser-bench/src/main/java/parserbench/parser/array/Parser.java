...
public class Parser {
    ...
    public static Node incrementalParse(Node oldTree, IncHelpers.NodeLocation leftCut, IncHelpers.NodeLocation rightCut, List<Node> changeStr) {
        ...
        if (leftCut != null) {
            ...
            divideResult = IncHelpers.removeSubtreesFromStart(oldTree);
        }
    ...
    private static Node incrementalParse(IncHelpers.DivideResult divideResult, IncHelpers.NodeLocation rightCut, List<Node> changeStr) {
        ...
        inputStack.push(new Node(Symbol.EOF, Node.Kind.NORMAL));
        ...
        while (!parseStack.isEmpty()) {
            ...
            if (X.symbol == Symbol.EOF) {
                ...
                if (Y.isTerminal()) {
                    ...
                    // Undo all nonterminals and attach them as unexpected
